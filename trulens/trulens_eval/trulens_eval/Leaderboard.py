...
from s3_download import read_logs_from_s3, write_logs_to_s3, read_text_file_s3
from trulens_deploy import run_records
...
#     data_dict = [
#     {
#         "prompt": "who is Narendra Damodar Modi ?",
#         "response":"Prime Minister of India",
#         "context": [
#                         "Narendra Modi is Prime Minister of India.",
#                         "Vijay Nagar is software Engineer.",                    
#                         "Narendra Chauhan is a engineer."
#                    ]
#     }
# ]
    list_file_not_processed = read_logs_from_s3()
    data_dict = read_text_file_s3(list_file_not_processed)
    run_records(data_dict)
    tru.get_leaderboard(app_ids=["ProfileHub1"])
    print(tru.get_leaderboard(app_ids=["ProfileHub1"]))
    write_logs_to_s3(list_file_not_processed, "close")
